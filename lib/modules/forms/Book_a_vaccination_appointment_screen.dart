...
class VaccinationAppointmentBooking extends StatelessWidget {
  static const String id = "vaccinationAppointmentBooking";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(title: "طلب تحصين", context: context),
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            dropDownMenuWithTitle(
                ...
                onChanged: (value) {}),
            dropDownMenuWithTitle(
                hintText: "نوع التحصين المطلوب",
                value: immunizationType,
                title: "نوع التحصين المطلوب",
                items: [],
                onChanged: (value) {}),
            Row(
              children: [
            ...
            textFieldWithTitle(
                title: "الموعد المناسب للتحصين",
                hintText: "الموعد المناسب للتحصين",
                suffixIcon: InkWell(
