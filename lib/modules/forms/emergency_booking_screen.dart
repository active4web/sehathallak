...
class EmergencyBooking extends StatelessWidget {
  static const String id = "emergencyBooking";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(title: "حجز موعد-حالات طارئة", context: context),
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            dropDownMenuWithTitle(
                ...
                onChanged: (value) {}),
            dropDownMenuWithTitle(
                hintText: "اختر الحالة الطارئة",
                value: immunizationType,
                title: "اختر الحالة الطارئة",
                items: [],
                onChanged: (value) {}),
            Row(
              children: [
